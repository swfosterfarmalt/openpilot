...
from selfdrive.car.gm.values import DBC, CanBus, CarControllerParams, CruiseButtons, CAR
    ...
    if self.CP.openpilotLongitudinalControl:
      ...
      if self.frame % 4 == 0:
        ...
        if self.CP.enableGasInterceptor and self.CP.carFingerprint == CAR.BOLT_EUV:
          can_sends.append(create_gas_interceptor_command(self.packer_pt, self.apply_gas, self.frame // 2))
        else:
