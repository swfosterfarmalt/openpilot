...
enum class EventName_baa8c5d505f727de: uint16_t {
  ...
  TORQUE_N_N_F_F_LOAD_SUCCESS,
  TORQUE_N_N_F_F_LOAD_FAILURE,
  TORQUE_N_N_F_F_NOT_LOADED,
};
...
public:
  ...
  inline bool hasNnffFingerprint() const;
  inline  ::capnp::Text::Reader getNnffFingerprint() const;
...
public:
  ...
  inline bool hasNnffFingerprint();
  inline  ::capnp::Text::Builder getNnffFingerprint();
  inline void setNnffFingerprint( ::capnp::Text::Reader value);
  inline  ::capnp::Text::Builder initNnffFingerprint(unsigned int size);
  inline void adoptNnffFingerprint(::capnp::Orphan< ::capnp::Text>&& value);
  inline ::capnp::Orphan< ::capnp::Text> disownNnffFingerprint();
...
inline bool CarParams::Reader::hasNnffFingerprint() const {
  return !_reader.getPointerField(
      ::capnp::bounded<14>() * ::capnp::POINTERS).isNull();
}
inline bool CarParams::Builder::hasNnffFingerprint() {
  return !_builder.getPointerField(
      ::capnp::bounded<14>() * ::capnp::POINTERS).isNull();
}
inline  ::capnp::Text::Reader CarParams::Reader::getNnffFingerprint() const {
  return ::capnp::_::PointerHelpers< ::capnp::Text>::get(_reader.getPointerField(
      ::capnp::bounded<14>() * ::capnp::POINTERS));
}
inline  ::capnp::Text::Builder CarParams::Builder::getNnffFingerprint() {
  return ::capnp::_::PointerHelpers< ::capnp::Text>::get(_builder.getPointerField(
      ::capnp::bounded<14>() * ::capnp::POINTERS));
}
inline void CarParams::Builder::setNnffFingerprint( ::capnp::Text::Reader value) {
  ::capnp::_::PointerHelpers< ::capnp::Text>::set(_builder.getPointerField(
      ::capnp::bounded<14>() * ::capnp::POINTERS), value);
}
inline  ::capnp::Text::Builder CarParams::Builder::initNnffFingerprint(unsigned int size) {
  return ::capnp::_::PointerHelpers< ::capnp::Text>::init(_builder.getPointerField(
      ::capnp::bounded<14>() * ::capnp::POINTERS), size);
}
inline void CarParams::Builder::adoptNnffFingerprint(
    ::capnp::Orphan< ::capnp::Text>&& value) {
  ::capnp::_::PointerHelpers< ::capnp::Text>::adopt(_builder.getPointerField(
      ::capnp::bounded<14>() * ::capnp::POINTERS), kj::mv(value));
}
inline ::capnp::Orphan< ::capnp::Text> CarParams::Builder::disownNnffFingerprint() {
  return ::capnp::_::PointerHelpers< ::capnp::Text>::disown(_builder.getPointerField(
      ::capnp::bounded<14>() * ::capnp::POINTERS));
}
